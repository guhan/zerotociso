...
- **Identification of Data Processing Activities** Businesses must identify and document all the data processing activities they engage in. This includes collecting, using, sharing, and retaining personal information.
- **Purposes of Data Processing** For each processing activity, businesses must specify the purposes for which personal information is collected and processed. These purposes should be consistent with what was disclosed to consumers when the data was collected.
- **Data Minimization** Businesses should assess whether they are collecting and retaining only the personal information that is necessary for the specified purposes. The principle of data minimization encourages businesses to limit the amount of personal information they collect and retain.
- **Data Security Measures** The risk assessment should include an evaluation of the security measures in place to protect personal information. This includes assessing whether the security measures are appropriate and effective in safeguarding data against unauthorized access or breaches.
- **Data Retention Periods** The assessment should consider the retention periods for different categories of personal information. Businesses should ensure that data is not retained longer than necessary for the purposes for which it was collected.
- **Consumer Rights Compliance** Businesses should assess their compliance with consumer rights, such as the right to access, delete, and correct personal information, as well as the right to opt-out of the sale of personal information.
- **Sensitive Personal Information** If the business processes sensitive personal information, it should evaluate how this data is handled and whether it is subject to heightened security measures and restrictions.
- **Third-Party Data Processors** If the business shares personal information with third-party service providers or processors, it should assess the contractual agreements and security measures in place to protect the data when it is in the hands of third parties.
- **Documentation** The results of the risk assessment should be documented, including any remediation actions taken to address identified risks or compliance gaps.
- **Regular Review** Businesses should conduct these risk assessments on an annual basis to ensure ongoing compliance with the CPRA's requirements and to adapt to changes in data processing activities or risks.
...
- **Written Agreements** Data processors must enter into written agreements with the businesses that hire them (referred to as "businesses" or "data controllers"). These agreements must outline the data processor's responsibilities and obligations regarding the processing of personal information on behalf of the data controller.
- **Limited Processing** Data processors are only permitted to process personal information on behalf of the data controller for the specific purposes specified in the written agreement. Any additional processing of personal information must be authorized by the data controller.
- **Confidentiality** Data processors must maintain the confidentiality of personal information and ensure that their employees and subcontractors also adhere to strict confidentiality requirements.
- **Security Measures** Data processors are required to implement and maintain reasonable security measures to protect personal information from unauthorized access, disclosure, alteration, or destruction.
- **Data Deletion** Data processors must assist data controllers in fulfilling consumer requests for data deletion. This includes the prompt deletion of personal information when instructed to do so by the data controller.
- **Data Access** Data processors must assist data controllers in responding to consumer requests for access to their personal information. This involves providing the data controller with the necessary information to fulfill these requests.
- **Data Portability** Data processors must assist data controllers in providing consumers with their personal information in a portable format upon request.
- **Audit and Assessment** Data processors may be subject to audits and assessments by the data controller or the California Privacy Protection Agency (CPPA) to verify compliance with the CPRA's requirements.
- **Subcontractor Requirements** Data processors must obtain the data controller's consent before engaging subcontractors to process personal information on their behalf. When subcontractors are used, the data processor remains responsible for ensuring that they comply with CPRA requirements.
- **Cooperation in Investigations** Data processors are required to cooperate with investigations and inquiries conducted by the CPPA.
- **Data Breach Notification** Data processors must notify data controllers promptly in the event of a data breach.
